...
class Translation {
    ...
    public static function get_dashboard_strings(): array {
        return [
            ...
            'PDF_ATTACHMENTS_NOT_SUPPORTED_IN_LITE'         => esc_html__('PDF attachments are not supported in the Lite version. Upgrade to Pro to enable PDF attachments.', 'stachethemes-seat-planner-lite'),
            ...
            'MOBILE_APP_NOT_SUPPORTED_IN_LITE'               => esc_html__('The mobile app is not supported in the Lite version. Upgrade to Pro to download and enable the Android app.', 'stachethemes-seat-planner-lite'),
