import { genericProperties } from "@src/admin/Product/SeatPlanner/components/Editor/components/Workflow/components/Objects/Generic/properties";
import { screenProperties } from "@src/admin/Product/SeatPlanner/components/Editor/components/Workflow/components/Objects/Screen/properties";
import { seatProperties } from "@src/admin/Product/SeatPlanner/components/Editor/components/Workflow/components/Objects/Seat/properties";
import { textProperties } from "@src/admin/Product/SeatPlanner/components/Editor/components/Workflow/components/Objects/Text/properties";
