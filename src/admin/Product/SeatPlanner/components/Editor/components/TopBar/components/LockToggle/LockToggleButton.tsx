...
import { useEditorObjects, useSelectObjects } from '@src/admin/Product/SeatPlanner/components/Editor/hooks';
...
const LockToggleButton = () => {
    ...
    const selectedObjectsData = objects.filter(obj => getIsSelected(obj.id));
